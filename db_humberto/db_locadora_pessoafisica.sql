...
CREATE TABLE `pessoafisica` (
  ...
  KEY `fk_pessoafisica_pessoa1_idx` (`id_pessoa`),
  CONSTRAINT `fk_pessoafisica_pessoa1` FOREIGN KEY (`id_pessoa`) REFERENCES `pessoa` (`id_pessoa`) ON DELETE CASCADE ON UPDATE CASCADE
